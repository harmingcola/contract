...
public class RequestHandlerServlet extends HttpServlet {
  ...
  @Override
  protected void doHead(HttpServletRequest httpRequest, HttpServletResponse httpsResponse) throws ServletException, IOException {
    ContractRequest contractRequest = from(httpRequest).toContractRequest();
    Contract contract = matchingService.matchHeadRequest(contractRequest);
    enableFilters(contract);
    contract = enricherService.enrichResponse(contract);
    writeResponse(httpsResponse, contract);
  }
